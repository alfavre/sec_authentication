pub const TTL: i64 = 15; // shoulde be wtwr chrono time is

// special thanks to : https://regexr.com/
pub const MAIL_REGEX: &'static str = r"^(?i)[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,4}$";
pub const DB_PATH: &'static str = "cooldatabase.txt";
